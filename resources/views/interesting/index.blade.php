...
<section class="interesting-about">
  <div class="interesting-about__inner main-container">
    <div class="interesting-about__txt">
      ...
      <p class="interesting-about__desc">В этом разделе предоставлены интересные видео и научно-популярные статьи для наших любимых пользователей. В этом разделе предоставлены
        интересные видео и научно-популярные статьи для наших любимых пользователей статьи для наших любимых пользователей</p>
    </div>

...
<section class="science-banner">
  ...
  <div class="science-banner__txt">
    <div class="science-banner__txt-inner main-container">
      ...
      <p class="science-banner__desc">В данном разделе вы можете ознакомиться с полезными и важными публикациями о здоровье. Постоянно обновляемые посты, поданные доступным языком разделены для вашего удобства по категориям. В каждой из категорий находится только актуальные и достоверная информация.</p>
    </div>
  </div>
</section>
